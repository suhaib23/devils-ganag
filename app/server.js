...
client.on("ready", () => {
  ...
  client.user.setActivity(`DEVILS GANG`, { type: "WATCHING" });
});
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@566701000480784385>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  ...
  message.channel.send("**:تم تسجيل دخولك في عصابة :japanese_ogre:DEVILS:japanese_ogre::**");
...
client.on("message", message => {
  if (message.content === "خروج") {
    message.channel.send("**:تم تسجيل خروجك من عصابة :japanese_ogre:DEVILS:japanese_ogre::**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "fr") {
    message.channel.send("**:هلا بلعرص:**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "طلب اجازة") {
    message.channel.send("**:المدة:**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "طلب استقالة") {
    message.channel.send("**:السبب:**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "صورة العصابة") {
    message.channel.send("**:https://cdn.discordapp.com/attachments/780530971115520012/780563981076267018/1d2a7399f0f475c6429dbcacc172444b.png:**");
    message.channel.sendFile("");
  }
});
